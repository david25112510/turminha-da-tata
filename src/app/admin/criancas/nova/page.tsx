...
export default function NewChildPage() {
  return (
    <div className="p-8 flex flex-col gap-6 max-w-2xl">
      ...
      <form action={createChildAction} className="bg-[#FFFDF8] rounded-2xl shadow-sm p-6 flex flex-col gap-5">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="flex gap-2 flex-wrap">
            {WEEKDAYS.map((day) => (
              <label
                key={day}
                className="flex items-center gap-1.5 border border-[#ECE1CB] rounded-lg px-3 py-1.5 text-xs font-semibold text-[#6B5D4A] cursor-pointer"
              >
        ...
        <label className="flex items-center gap-2 text-sm text-[#4A3F33]">
