...
export default async function EnrollmentPage() {
  ...
  return <main className="min-h-screen bg-tata-bg px-4 py-6 sm:py-10"><div className="mx-auto max-w-3xl flex flex-col gap-5">
    <header className="flex items-center justify-between"><Link href="/" className="font-[family-name:var(--font-baloo)] text-lg font-bold text-tata-green-dark">Turminha da Tata</Link><Link href="/login" className="min-h-11 inline-flex items-center px-4 font-bold text-tata-ink-soft">ENTRAR</Link></header>
