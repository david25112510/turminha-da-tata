...
- **Não existe Política de Privacidade como documento separado** — o fluxo de consentimento LGPD (`Consent`/`ConsentAcceptance`, distinto do Contrato) cobre a base legal de tratamento de dados, mas não há uma página própria "🔐 Privacidade" no portal com o texto da política em si, separada do contrato de prestação de serviço e das autorizações de imagem.
